    ...
    public static object HitTest(this Canvas self, Point p, Type []neededObjects)
    {
      ...
      return
        (from FrameworkElement element in
         ...
         where neededObjects.Any(type => frameworkElementType.IsSubclassOf(type) || frameworkElementType.Equals(type))
