...
Public Class YahooData
    ...
    Public Function GetHistory(ByVal value As HistoryRequest) As BarInfo
    ...
    Private Function ParseData(ByVal token As HistoryRequest, ByVal result As String) As BarInfo
        Dim ret As New BarInfo() With { _
         .Token = token, _
         .Bars = New List(Of Bar) _
        }
    ...
    Private Function GetHistiryRequestUri(ByVal value As HistoryRequest) As Uri
    ...
    Private Function GetBeginDate(ByVal barType As Periodicity, ByVal period As Integer, ByVal bars As Integer) As System.DateTime
    ...
    Private Function ParseDate(ByVal dateStr As String) As System.DateTime
